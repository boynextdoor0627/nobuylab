const pauseOptions = [
  { id: 'food', icon: '🧋', label: '吃喝', defaultName: '顺手买点吃的', copy: '先喝水、走两分钟，等一下再决定。' },
  { id: 'digital', icon: '🎧', label: '数码', defaultName: '一个新的数码装备', copy: '先问旧的还能不能用，而不是新品有多好。' },
  { id: 'wear', icon: '👟', label: '穿搭', defaultName: '一件新的穿搭单品', copy: '先看衣柜里有没有相似功能的东西。' },
  { id: 'beauty', icon: '🧴', label: '护肤', defaultName: '一瓶新的护肤品', copy: '先查库存和开封日期，别让低价变囤货。' },
  { id: 'home', icon: '🛋️', label: '家居', defaultName: '一个家居小物', copy: '先确认摆放位置和使用频率。' },
  { id: 'other', icon: '🛍️', label: '其他', defaultName: '一次消费冲动', copy: '把它记下来，今天先不急着付款。' }
]
...
const plazaPosts = [
  {
    ...
    body: ['旧耳机还能通话、降噪也正常，唯一的问题是我刷了太多新品测评。', '先放进冷静记录，30 天后如果还是影响使用，再重新判断。'],
    tags: ['数码', '守住¥1899'],
    likes: 286,
    comments: [
